...
127.0.0.1/mod_mysql_basic_imdb_movies./movies/		http://localhost/phpmyadmin/db_sql.php?db=mod_mysql_basic_imdb_movies.
 Weergave van records 0 - 24 (98 totaal, Query duurde 0,0003 seconden.)

SELECT * FROM movies


movie_id	movie	year	rating	
